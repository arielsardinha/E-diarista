                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="icone" id="icone" class="form-control">
                            <option value="">Selecione o icone</option>
                            <option value="twf-cleaning-1"
                                {{ isset($servico) && ($servico->icone === 'twf-cleaning-1' ? 'selected' : '') }}>
                                Ícone 1</option>
                            <option value="twf-cleaning-2"
                                {{ isset($servico) && ($servico->icone === 'twf-cleaning-2' ? 'selected' : '') }}>
                                Ícone 2</option>
                            <option value="twf-cleaning-3"
                                {{ isset($servico) && ($servico->icone === 'twf-cleaning-3' ? 'selected' : '') }}>
                                Ícone 3</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ $servico->posicao ?? '' }}" type="input" class="form-control" name="posicao"
                            id="posicao" required placeholder="Posição do serviço na plataforma">
                    </div>
                </div>
            </div>
        </fieldset>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="input" value="{{ $servico->valor_minimo ?? '' }}" class="form-control"
